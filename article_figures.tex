...
\begin{tikzpicture}
    \begin{axis}[
            ...
            x label style = {
                at = {(axis description cs:0.5,-0.05625)},
                anchor = north,
            },
            y label style = {
        ...
        \legend{\(\lambda = 0\) (LQR), \(50\%\) interval, \(95\%\) interval,
                \(\lambda = 0.1\), \(50\%\) interval, \(95\%\) interval,
                \(\lambda = 1\), \(50\%\) interval, \(95\%\) interval}
    \end{axis}
    \useasboundingbox (-1.125, -0.75) rectangle (10.25, 5.25);
\end{tikzpicture}%
...
\begin{tikzpicture}
    \begin{axis}[
            ...
            ylabel = {State Energy},
            x label style = {
                at = {(axis description cs:0.5,-0.06875)},
                anchor = north,
            },
            y label style = {
                at = {(axis description cs:-0.0625,0.5)},
